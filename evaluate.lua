...
-- bookkeeping
cmd:option('-checkpoint_file', 'checkpoints/vqa_epoch50.00_0.4576.t7', 'Checkpoint file to use for predictions')
...
for i = 1, loader.batch_data.val.nbatches do
    ...
    qf = checkpoint.protos.ltw:forward(c_batch)

    imf = checkpoint.protos.lti:forward(t_batch)
